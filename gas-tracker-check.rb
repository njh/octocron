...
puts "Tracker (#{config['gas_tracker_tariff']}): #{tracker_rate} p/kWh"

variable_rate = octopus.get_single_rate_for_day(:gas, config['gas_variable_tariff'], date)
puts "Variable (#{config['gas_variable_tariff']}): #{variable_rate} p/kWh"

fixed_rate = octopus.get_single_rate_for_day(:gas, config['gas_fixed_tariff'], date)
puts "Fixed (#{config['gas_fixed_tariff']}): #{fixed_rate} p/kWh"
